...
<html>
  ...
  <body class="bg-grey" id="myPage" data-spy="scroll" data-target=".navbar" data-offset="60">
    ...
    <div class="jumbotron text-center">
      <h1>Agriculture Portal - Seller</h1>
    ...
    <div style="padding:0px 0px" class="container-fluid">
      <div class="row">
        ...
        <div class="row">
          ...
          <?php
             if(isset($_POST["add"])){
                ...
                $date = date("Y-m-d");
                $qr = "INSERT INTO product VALUES ('','$name','$dst1','$disc','$subsidy','$quantity','$price','$date','$_SESSION[id]')";
                mysqli_query($link,$qr);
                ?><script>alert("product successfully added.");</script><?php
                ?><script>window.location="./seller_profile.php";</script><?php
              }
           ?>
        </div>
        ...
        <div class="row">
          <div class="col-sm-12">
            <?php
                $qr = "SELECT * FROM sell_prod WHERE seller_id='$_SESSION[id]'";
          ...
          $row=mysqli_fetch_array($rel);
            ...
            <div class='col-sm-12'>
              <div class='thumbnail text-center bg-grey'>
                <img src=../advertiser/".$row['image']." alt='PRODUCTS_image' width='200px' height='300px'>
