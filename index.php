...
<body id="myPage" data-spy="scroll" data-target=".navbar" data-offset="60">
  ...
  <div class="jumbotron text-center">
    ...
    <p>Platform For Every Farmer of India</p>
    ...
    <div id="myCarousel" class="carousel slide text-center" data-ride="carousel">
      ...
      <div class="carousel-inner" role="listbox">
        <div class="item active">
          <h4>"This portal is the best. I am so happy with the result!"<br><span>Neel Patel, Vice President, Gujarat agricultural association</span></h4>
        </div>
        <div class="item">
          <h4>"I am very impressed with this portal,it provides such an easy way to use."<br><span>Hrushi Khant, farmer, Mahesana</span></h4>
        </div>
        <div class="item">
          <h4>"This portal is very good and provide a modernized approach to agriculture."<br><span>Het Prajapati, farmer, Nagvasan</span></h4>
        </div>
      </div>
  ...
  <div class="container-fluid bg-grey">
    <div class="row">
      ...
      <div class="col-sm-8">
        <h2>Our Values</h2><br>
        <p><strong>MISSION:</strong>Our mission is to work for betterment of Indian farmers and provide them transparent cost for their products and easy platform that they can use for selling or buying products.</p><br>
  ...
  <div id="contact" class="container-fluid bg-grey">
    ...
    <div class="row">
      ...
      <div class="col-sm-5">
        ...
        <p><span class="glyphicon glyphicon-copyright-mark"></span> Made By : Parthiv Patel</p>
      </div>
